...
import (
	...
	"github.com/facebookincubator/ent/entc/integration/entprivacy/migrate"
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	if _, ok := c.driver.(*txDriver); ok {
		return nil, fmt.Errorf("entprivacy: cannot start a transaction within a transaction")
	}
	tx, err := newTx(ctx, c.driver)
	if err != nil {
		return nil, fmt.Errorf("entprivacy: starting a transaction: %v", err)
	}
...
func (c *PlanetClient) Use(hooks ...ent.Hook) {
...
func (c *PlanetClient) Create() *PlanetCreate {
	...
	mutation := newPlanetMutation(OpCreate)
...
func (c *PlanetClient) Update() *PlanetUpdate {
	hooks := append(planet.Hooks[:], c.hooks...)
	mutation := newPlanetMutation(OpUpdate)
...
func (c *PlanetClient) UpdateOneID(id int) *PlanetUpdateOne {
	hooks := append(planet.Hooks[:], c.hooks...)
	mutation := newPlanetMutation(OpUpdateOne)
	mutation.id = &id
...
func (c *PlanetClient) Delete() *PlanetDelete {
	hooks := append(planet.Hooks[:], c.hooks...)
	mutation := newPlanetMutation(OpDelete)
