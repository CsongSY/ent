...
//	Aggregate(entprivacy.As(entprivacy.Sum(field1), "sum_field1"), (entprivacy.As(entprivacy.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
//
...
func (e *NotFoundError) Error() string {
	return "entprivacy: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "entprivacy: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "entprivacy: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "entprivacy: constraint failed: " + e.msg
}
