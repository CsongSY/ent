...
func newPlanetMutation(op string) *PlanetMutation {
...
func (m *PlanetMutation) ID() (id int, _ bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *PlanetMutation) Name() (r string, _ bool) {
	v := m.name
	if v == nil {
		return
	}
...
func (m *PlanetMutation) Age() (r uint, _ bool) {
	v := m.age
	if v == nil {
		return
	}
...
func (m *PlanetMutation) AddedAge() (r uint, _ bool) {
	v := m.addage
	if v == nil {
		return
	}
...
func (m *PlanetMutation) Op() string {
	return m.op
}
