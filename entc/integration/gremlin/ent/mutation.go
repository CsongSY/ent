...
func newCardMutation(c config, op string) *CardMutation {
	return &CardMutation{
		op:            op,
		typ:           TypeCard,
...
func newCommentMutation(c config, op string) *CommentMutation {
...
func newFieldTypeMutation(c config, op string) *FieldTypeMutation {
...
func newFileMutation(c config, op string) *FileMutation {
	return &FileMutation{
		op:            op,
		typ:           TypeFile,
		clearedFields: make(map[string]bool),
...
func newFileTypeMutation(c config, op string) *FileTypeMutation {
...
func newGroupInfoMutation(c config, op string) *GroupInfoMutation {
...
func newItemMutation(c config, op string) *ItemMutation {
	return &ItemMutation{
		op:            op,
		typ:           TypeItem,
		clearedFields: make(map[string]bool),
...
func newNodeMutation(c config, op string) *NodeMutation {
	return &NodeMutation{
		op:            op,
		typ:           TypeNode,
		clearedFields: make(map[string]bool),
...
func newSpecMutation(c config, op string) *SpecMutation {
	return &SpecMutation{
		op:            op,
		typ:           TypeSpec,
		clearedFields: make(map[string]bool),
